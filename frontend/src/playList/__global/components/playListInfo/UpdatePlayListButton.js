...
const UpdatePlayListButton = ({onClickSaveButton, defaultTitle, ...props}) => {
  ...
  return (
    ...
    <Dialog open={isDialogOpend} onClose={()=>{setIsDialogOpend(false);}}>
      <DialogTitle sx={{color: "black", fontWeight: "bolder", fontFamily: "BMDfont"}}>플레이 리스트 편집</DialogTitle>
      <DialogContent>
        <Stack>
            <StyledTextField
                name="title"
...
export default UpdatePlayListButton;