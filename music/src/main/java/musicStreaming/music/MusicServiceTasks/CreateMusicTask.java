...
public class CreateMusicTask {
    ...
    public static CreateMusicResDto createMusicTask(CreateMusicReqDto createMusicReqDto, Long userId, 
        ...
        DataUrlStorageService service = new DataUrlStorageService();
        String dataUrlCode = service.writeDataUrlToFile(createMusicReqDto.getDataUrl());

        MusicFileUploadRequested musicFileUploadRequested = new MusicFileUploadRequested(music, dataUrlCode);

        music.setId(musicFileUploadRequested.getId());
        music.setCreaterId(musicFileUploadRequested.getCreaterId());
        music.setTitle(musicFileUploadRequested.getTitle());
        music.setCreater(musicFileUploadRequested.getCreater());
        music.setLikes(musicFileUploadRequested.getLikes());
        music.setCreatedDate(musicFileUploadRequested.getCreatedDate());
        music.setUpdatedDate(musicFileUploadRequested.getUpdatedDate());
