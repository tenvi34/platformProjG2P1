...
public class DeleteMusicByFailTask {
    ...
    public static void deleteMusicByFailTask(MusicFileUploadFailed musicFileUploadFailed,
        ...
        Long musicId = musicFileUploadFailed.getMusicId();
        ...
        MusicDeletedByFail musicDeletedByFail = new MusicDeletedByFail(music);
        musicDeletedByFail.publishAfterCommit();

        // [4] dataUrlStorageService를 이용해서 dataUrlCode에 해당하는 파일을 삭제시킵니다.
        String dataUrlCode = musicFileUploadFailed.getDataUrlCode();
        dataUrlStorageService.deleteDataUrlFile(dataUrlCode);

        // MockMusicFileUploadFailedReqDto, MusicFileUploadFailed 를 수정하여 구현하였습니다.
